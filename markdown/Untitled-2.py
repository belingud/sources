...
import time
import qrcode
alipay_public_key_string = '''-----BEGIN PUBLIC KEY-----YOUR_ALIPAY_PUBLIC_KEY-----END PUBLIC KEY-----'''
...
def preCreateOrder(subject: 'order_desc', out_trade_no: int,
...
def query_order(out_trade_no: int, cancel_time: intand'secs'):
    '''
...
def need_refund(out_trade_no: str orint, refund_amount: intorfloat, out_request_no: str):
    '''
    退款操作
    :param out_trade_no: 商户订单号
...
def refund_query(out_request_no: str, out_trade_no: str orint):
    '''
