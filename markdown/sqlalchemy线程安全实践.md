...
class DBManager:
    ...
    def __init__(self, db, engine_options=None, session_options=None, is_async=False):
        """
        :param db: 数据库名
    ...
    def create_session(self, **session_options):
        ...
        if self.is_async is False:
            ...
            self._async_factory = sessionmaker(class_=AsyncSession, bind=self._async_engine, **session_options)
