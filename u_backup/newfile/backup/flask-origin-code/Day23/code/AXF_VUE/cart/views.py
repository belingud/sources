...
from rest_framework.exceptions import APIException, NotAuthenticated, ParseError, PermissionDenied
from rest_framework.generics import GenericAPIView, ListCreateAPIView
from rest_framework.response import Response
from rest_framework.status import HTTP_201_CREATED, HTTP_204_NO_CONTENT

from cart.authentications import UserTokenAuthentication
...
class CartsView(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        #     #
        #     # return Response(data)
        #     raise NotAuthenticated(detail="not login")
    ...
    def get_cart_object(self):
        ...
        #
        # # user = UserModel()
        # # cart_obj = user.cartmodel_set.filter(pk=cart_id)
    ...
    def add_to_cart_num(self, request, *args, **kwargs):
        ...
        # # cart_obj = user.cartmodel_set.filter(pk=cart_id)
        #
        # cart_obj = request.user.cartmodel_set.filter(pk=cart_id).first()
        #
        # if not cart_obj:
        #     raise PermissionDenied(detail="not found")
